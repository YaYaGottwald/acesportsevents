...
<main>
    ...
    <comment>Succcess</comment>
    <section class="section group">
        <article class="col span_7_of_12">
            <h2>Congratulations!</h2>
            <p>Our records show you registered the following:<br>
                <strong>Name:</strong> <?php echo htmlspecialchars($myFirstName, ENT_QUOTES, 'UTF-8') . '&nbsp;' . htmlspecialchars($myLastName, ENT_QUOTES, 'UTF-8');?><br>
                <strong>Email:</strong> <?php echo htmlspecialchars($myREmail, ENT_QUOTES, 'UTF-8');?><br>
                <strong>Shirt Size:</strong> <?php echo htmlspecialchars($myShirt, ENT_QUOTES, 'UTF-8');?><br>
                <strong>Event:</strong>
                <?php
                    if ($Saturday == ' ') {
                        echo ' Sunday - ' . htmlspecialchars($Sunday, ENT_QUOTES, 'UTF-8');
                    } elseif ($Sunday == ' ') {
                        echo ' Saturday - ' . htmlspecialchars($Saturday, ENT_QUOTES, 'UTF-8');
                    } else {
                        echo ' Saturday - ' . htmlspecialchars($Saturday, ENT_QUOTES, 'UTF-8') . ' <strong>AND</strong> Sunday - '
                            . htmlspecialchars($Sunday, ENT_QUOTES, 'UTF-8');
                    }
                ?><br>
                <?php
                    if ($splashOptIn == 'yes') {
                        echo "<p>Now let's get your young athlete registered for the <a href='../splash/'>Splash n' Dash!</a></p>";
                    }
                ?>
            </p>
            <h2>Packet Pickup</h2>
        ...
        <aside class="col span_5_of_12">
            <p>Prepare to have loads of fun!</p>
